const MoonIcon = (props: React.SVGAttributes<SVGElement>) => {
  const { width = '28', height = '28', fill = 'none', ...rest } = props;
  return (
    <svg
      ...
      {...rest}
    >
      <g fill={fill} fillRule="evenodd" transform="translate(-440 -200)">
        <path
          fill="currentColor"
          fillRule="nonzero"
          stroke="currentColor"
