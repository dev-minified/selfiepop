...
function PinPost({
  ...
  const userPinPostState = useAppSelector((state) => state.memberPost.pinPosts);
  ...
  const getComponent = () => {
    ...
    return (
      <React.Fragment>
        {pinArray.length > 0 &&
          pinArray.map((ele: any) => {
            const PinItem = userPinPostState?.[ele];
            let timestamp =
            ...
            return personAccessType === PostTierTypes.hidden &&
              !isFreeSubExist ? null : (
              <Card cardClass="mb-20 post-card" key={ele}>
                <Card.Header
                  ontitleClick={() => {
                  ...
                  isPinPost={!!userPinPostState?.[ele]}
                  Rightside={() => {
                  ...
                  <>
                    ...
                    <Card.Footer>
                      <CardPublicFooter
                        ...
                        isSeller={isSeller}
                      />
                      {isSeller ? null : <TipsBar postId={ele} />}
                    </Card.Footer>
