...
function PromotionalShoutoutPopType({ className }: Props): ReactElement {
          ...
          <li
            onClick={() => {
              handleClick(
                {
                  pathStep: subType,
                  slider: 'PromotionalShoutout',
                  step: 1,
                },
                'Add Promotional Shoutout',
              );
            }}
          >
...
export default styled(PromotionalShoutoutPopType)`
  .list-course-detail {
    margin: 0;
    padding: 0;
    list-style: none;
