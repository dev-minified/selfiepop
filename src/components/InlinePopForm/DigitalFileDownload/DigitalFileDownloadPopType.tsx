...
import { ChevronRight, UploadBold } from 'assets/svgs';
...
function DigitalFileDownloadPopType({ className }: Props): ReactElement {
...
export default styled(DigitalFileDownloadPopType)`
  .list-course-detail {
    margin: 0;
    padding: 0;
    list-style: none;
