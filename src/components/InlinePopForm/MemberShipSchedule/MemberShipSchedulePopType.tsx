...
import { ChevronRight, Dollar } from 'assets/svgs';
...
function MemberShipSchedulePopType({ className }: Props): ReactElement {
...
export default styled(MemberShipSchedulePopType)`
  .list-course-detail {
    margin: 0;
    padding: 0;
    list-style: none;
